<article class="post post-full card bg-white shadow-sm border-0" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post-toc-card card shadow-sm" id="post-toc" aria-label="<?php _e('文章目录', 'argon'); ?>">
		<button class="post-toc-card__toggle" type="button" aria-expanded="false">
			<i class="fa fa-list-alt" aria-hidden="true"></i>
			<span><?php _e('目录', 'argon'); ?></span>
			<i class="fa fa-chevron-down post-toc-card__chevron" aria-hidden="true"></i>
		</button>
		<nav class="post-toc-card__body" aria-label="<?php _e('文章目录', 'argon'); ?>"></nav>
	</div>
