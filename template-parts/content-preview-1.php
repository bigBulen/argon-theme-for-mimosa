		...
		<?php
			if (argon_has_post_thumbnail()){
				...
				if (get_option('argon_enable_lazyload') != 'false') {
					echo "<img class='post-thumbnail lazyload' src='data:image/png;base64,...' data-original='" . $thumbnail_url . "' alt='thumbnail'>";
				} else {
					echo "<img class='post-thumbnail' src='" . $thumbnail_url . "' alt='thumbnail'>";
				}
				echo "<div class='post-thumbnail-mask'></div></div>";
